...
my $url3 = 'http://api.openweathermap.org/data/2.5/weather?q=Badalona&mode=xml&units=metric&APPID=1a762a6a965ba974e55e0c3d18670b12';
#my $url = 'http://api.openweathermap.org/data/2.5/find?q=Badalona&units=metric&mode=xml&cnt=2&APPID=1a762a6a965ba974e55e0c3d18670b12';
my $url2 ='http://api.openweathermap.org/data/2.5/forecast/daily?q=Badalona&mode=xml&units=metric&cnt=2&APPID=1a762a6a965ba974e55e0c3d18670b12';
...
print "cond1::";
  ...
  print "$score"; print "::";
my $sensor=`cd /home/pi/scripts/regautomatic/arduino-serial-master && ./arduino-serial -b 9600 -p /dev/ttyUSB0 -s "s" -r | grep "read string:" | sed 's/read string://g'`;
$sensor=~ s/[\r\n]//g;
print "$sensor";print "::";
...
my $var2=`cd /home/pi/scripts/regautomatic/arduino-serial-master && ./arduino-serial -b 9600 -p /dev/ttyUSB0 -s "c" -r | grep "read string:rebut" | wc -l`;
